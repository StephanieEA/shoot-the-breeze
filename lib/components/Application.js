...
export default class Application extends Component {
  ...
  // findUsers(){
  //   // find all users in message array  const fireBaseKeys = mobject ? Object.keys(mobject) : [];
  //     let userArray = []
  //     let userList = this.state.messages
  //     userList.map((mobjects) => {
  //       const soloMobject = mobject[userKey];
  //       soloMobject['user'] = userKey;
  //       userList.push(soloMobject)
  //     });
  //     return userList;
